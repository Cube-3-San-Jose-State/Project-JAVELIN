    ...
    public:
        ...
        Container_Data ParseMissionControlData(std::string &response)
        {
            ...
            int actual_arguments = sscanf(
                ...
                &container_data_.id, &container_data_.heartbeat_count, &container_data_.is_operational, &container_data_.payload_deployed, &container_data_.flight_mode, &container_data_.air_speed, &container_data_.gps_data.latitude, &container_data_.gps_data.longitude, 
                &container_data_.barometer_data.altitude, &container_data_.barometer_data.temperature, &container_data_.imu_data.acceleration_x, 
        ...
        /* String JSONifyData(Container_Data data)
        {
            char json_data[500];
            snprintf(
