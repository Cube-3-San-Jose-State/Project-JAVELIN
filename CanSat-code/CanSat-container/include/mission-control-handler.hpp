    ...
    public:
        ...
        Container_Data ParseMissionControlData(std::string &response)
        {
            ...
            int actual_arguments = sscanf(
                ...
                &container_data_.gps_data.latitude, &container_data_.gps_data.longitude, &container_data_.gps_data.exactAltitude,
                &container_data_.barometer_data.relativeAltitude, &container_data_.barometer_data.temperature,
