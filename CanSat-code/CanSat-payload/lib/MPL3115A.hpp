    ...
    class MPL3115A
    {
        private:
            struct barometer_data{
                unsigned int status;
                unsigned int altitude_msb1;
                unsigned int altitude_msb;
                unsigned int altitude_lsb;
                unsigned int temperature_msb;
                unsigned int temperature_lsb;
                unsigned int pressure_msb1;
        ...
        public:
            ...
            void Update() {
                ...
                altitude  = (((long)(barometer_data.altitude_msb1 * (long)65536) + (barometer_data.altitude_msb*256) + (barometer_data.altitude_lsb & 0xF0)) / 256.0);
