...
namespace CanSat
{
    ...
    public:
        std::string CreateGETRequestParameterWithRoverStatus(Payload_Data data)
        {
            ...
            snprintf(
                ...
                data.heartbeat_count, data.is_operational, data.flight_mode, data.air_speed, data.camera_status.trig, 
        ...
        Payload_Data ParseMissionControlData(std::string &response)
        {
            ...
            int actual_arguments = sscanf(
                ...
                &payload_data_.heartbeat_count, &payload_data_.is_operational, &payload_data_.flight_mode, &payload_data_.air_speed, &payload_data_.camera_status.trig, 
    ...
    private:
        ...
        const int kExpectedNumberOfArguments = 14;
    };
