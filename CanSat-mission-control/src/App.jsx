...
class App extends Component {
	...
	render() {
    	return (
      		<>
				<div className="menu">
					<button id="open" onClick={this.readSerial.bind(this)}>Open</button>
				</div>
				<div className="blocks-container">
					<div className="block">
						<PrettyData data={this.state.data}/>
					</div>
					<div className="block">gyro info</div>
					<div className="block">accel info</div>
	...
	async readSerial(){
		...
		let builderString = "";
		await port.open({ baudRate: 9600, bufferSize: 512 });
